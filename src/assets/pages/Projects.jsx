  ...
  return (
    <>
      <main className="bg-c-2 dark:bg-d-2 pt-20">
        <div className=''>
          <h2 className='pl-5 pt-2 text-c-1 dark:text-d-1 text-xl font-medium'>{t("Projects.Frontend")}</h2>
            ...
            <div className="flex gap-4 dark:text-d-4">
              <div className="card">
                ...
                <div className="card__content bg-c-3 dark:bg-d-3 text-c-1 dark:text-d-1">
                  <p className="card__title">{t("Projects.CF3")}</p>
                  <p className="card__description">{t("Projects.CF3C")}</p>
        ...
        <h2 className='pl-5  text-c-1 dark:text-d-1 text-xl font-medium'>{t("Projects.Backend")}</h2>
        <div className='pl-10'>
